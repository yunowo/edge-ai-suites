...
#ifndef HCE_AI_INF_MEDIA_3C_OUTPUT_NODE_HPP
#define HCE_AI_INF_MEDIA_3C_OUTPUT_NODE_HPP
...
#define MEDIA_3C_OUTPUT_NODE_INPORT_NUM 3
...
class HCE_AI_DECLSPEC Media3COutputNodeWorker : public hva::hvaNodeWorker_t {
  public:
    Media3COutputNodeWorker(hva::hvaNode_t *parentNode, const std::string &bufType);
...
class HCE_AI_DECLSPEC Media3COutputNode : public baseResponseNode {
  public:
    Media3COutputNode(std::size_t totalThreadNum);

    ~Media3COutputNode() = default;
...
#endif  // #ifndef HCE_AI_INF_MEDIA_3C_OUTPUT_NODE_HPP